...
-- kh /sample 사용자 계정끼리 서로의 객체 접근 부여
...
-- 3. (sample) 다시 kj 계정의 EMPLOYEE 조회
SELECT * FROM kh.EMPLOYEE; -- 조회 됨
SELECT * FROM kh.DEPARTMENT; -- 조회안됨
...
SELECT EMP_ID 사번, EMP_NAME 이름,
					...
					WHERE DESCODE(SUBSTR(EMP_NO, 8, 1), '1', 'M', '2', 'F') = F
