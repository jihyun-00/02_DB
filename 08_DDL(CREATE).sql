...
-- DEFAULT 설정된 컬럼이라고 삽입/수정 시 DEFAULT만 작성해야 하는 것은 아님!
...
CREATE TABLE USER_USED_NN (
	USER_NO NUMBER NOT NULL, -- 사용자번호(모든 사용자는 사용자 번호가 반드시 있어야 한다!)
													 -- 컬럼 레벨 제약조건 설정
	USER_ID VARCHAR2(20),
...
INSERT INTO USER_USED_UK VALUES (
1, NULL,'PASS01', '홍길동', '남자', '010-1234-5678', 'hong_gd@or.kr');
--> 아이디에 NULL 삽입 가능 확인

INSERT INTO USER_USED_UK VALUES (
1, NULL,'PASS01', '홍길동', '남자', '010-1234-5678', 'hong_gd@or.kr');
--> 아이디에 NULL 중복 삽입 가능 확인

-----------------------------------------------------------------------------

-- UNIQUE 복합키
-- 두개 이상의 컬럼을 묶어서 하나의 UNIQUE 제약조건을 설정
...
INSERT INTO USER_USED_UK2 VALUES (
1, 'USER01','PASS01', '고길동', '남자', '010-1234-5678', 'hong_gd@or.kr');


--UNIQUE(USER_ID, USER_NAME) 두개 모두 같아야 위배
...
-- USER_NO, USER_ID 둘다 중복되었을 때만 제약조건 위배 에러 발생!
...
--NULL을 ("KH"."USER_USED_PK2"."USER_ID") 안에 삽입할 수 없습니다
...
INSERT INTO USER_USED_FK VALUES (
2, 'USER02','PASS02', '이순신', '남자', '010-5678-1234', 'lee_ss@or.kr', 10);

INSERT INTO USER_USED_FK VALUES (
3, 'USER03','PASS03', '유관순', '여자', '010-3333-1111', 'yoo_ks@or.kr', 30);

INSERT INTO USER_USED_FK VALUES (
4, 'USER04','PASS04', '안중근', '남자', '010-2222-5555', 'ahn_jk@or.kr', NULL);

INSERT INTO USER_USED_FK VALUES (
5, 'USER05','PASS05', '윤봉길', '남자', '010-6666-7777', 'yoon_bg@or.kr', 50);
--무결성 제약조건(KH.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
-- 무결성 제약조건(KH.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다

-- GRADE_CODE 중 20은 사용되지 않고 있으므로 삭제 가능
...
1, 'USER01','PASS01', '홍길동', '남자', '010-1234-5678', 'hong_gd@or.kr');
--남, 여만 가능한데 남자 라는 다른 문자열이 들어와 위배
...
INSERT INTO USER_USED_CHECK VALUES (
2, 'USER02','PASS02', '유관순', '여', '010-3333-1111', 'yoo_ks@or.kr');
--가능

--> GENDER 컬럼에 CHECK 제약조건으로
-- '남' 또는 '여'만 삽입 가능하도록 설정
