...
-- DPET_COPY2 테이블에서 DEPT_ID, LOCATION_ID 컬럼만 이용해서
-- V_DCOPY2 VIEW 생성
...
-- V_DCOPY2 VIEW룰 이용해서 INSERT 수행
INSERT INTO V_DCOPY2
VALUES ('D0', 'L2');
-- 가상 테이블인 VIEW인데도 INSERT 성공!
...
--> NULL은 DB의 무결성을 약하게 만드는 주요 원인 중 하나
 ...
 * [CACHE | NOCACHE]
 * 
 * -- CREAT랑 거의 똑같은데 STARTWITH만 변경안된다는 점
 * 
 *  */
...
--> EMPLOYEE 테이블의 EMP_NAME 컬럼에 대해 빠른 검색 가능
...
-- 변수, 조건문(IF/CASE), 반복문(LOOF,WHILE) 사용 가능
BEGIN
